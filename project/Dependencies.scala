...
object Dependencies {
  ...
  lazy val coreDeps = commonDeps ++ Seq(
    ...
    "co.elastic.clients"           % "elasticsearch-java" % "7.16.3" withJavadoc(),
    "com.fasterxml.jackson.core"   % "jackson-core"       % "2.13.1" withJavadoc(),
    "com.fasterxml.jackson.core"   % "jackson-databind"   % "2.13.1" withJavadoc(),
